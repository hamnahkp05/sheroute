          ...
          <Card className="border-none shadow-lg bg-white overflow-hidden">
            <CardContent className="p-6 flex items-center gap-6">
              <Avatar className="w-20 h-20 border-4 border-primary/10">
                <AvatarImage src={userImg?.imageUrl} />
                <AvatarFallback>JD</AvatarFallback>
              </Avatar>
              <div className="space-y-1">
                <h2 className="text-xl font-black text-primary">Jane Doe</h2>
                <p className="text-sm text-muted-foreground">Safety Score: <span className="text-primary font-bold">Gold Elite</span></p>
                <Badge variant="outline" className="text-[10px] font-bold">MEMBER SINCE 2024</Badge>
              </div>
            </CardContent>
          </Card>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-3">
            {contacts.map((contact) => (
              <Card key={contact.name} className="border-none shadow-md bg-white">
